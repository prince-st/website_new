...
import { Linkedin, Github, Mail, ExternalLink, Sparkles, ArrowUp } from "lucide-react";
    ...
    <footer className="relative py-6 sm:py-8 lg:py-12 border-t-2 border-border/50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-6 sm:mb-8">
          ...
          <div className="lg:col-span-2 space-y-3 animate-fade-in-up">
            <Link to="/" className="group inline-flex items-center gap-3">
              <div className="relative w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-cyan-500 flex items-center justify-center shadow-xl group-hover:shadow-primary/50 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 overflow-hidden">
                ...
                <span className="relative text-primary-foreground font-heading font-bold text-2xl drop-shadow-lg">B</span>
              </div>
              <div>
                <span className="font-heading font-bold text-xl bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent group-hover:from-primary group-hover:to-cyan-400 transition-all duration-300 block">Bharat Gunani</span>
            ...
            <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
              AI Consultant, Development & Digital Growth Partner.
              From strategy to deployment — Building AI-powered systems, high-performance eCommerce platforms, and automated workflows that scale your business without scaling your headcount.
            </p>
          ...
          {/* Enhanced Services with ScrollToTop */}
          <div className="animate-fade-in-up relative" style={{ animationDelay: '0.2s' }}>
            <div className="flex items-start justify-between gap-8">
              <div className="flex-1">
                ...
                <ul className="space-y-2">
                  {["AI Consulting", "Web Development", "UI/UX Design", "Digital Marketing"].map((service, idx) => (
              ...
              {/* Enhanced Scroll to Top Button - Right Side */}
              <button
                onClick={scrollToTop}
              ...
              >
                ...
                <ArrowUp className="relative w-6 h-6 text-primary group-hover:text-primary drop-shadow-[0_0_8px_hsl(var(--primary)/0.8)] group-hover:-translate-y-1 transition-all" />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="pt-4 sm:pt-6 border-t-2 border-border/50 flex flex-col md:flex-row justify-between items-center gap-3 animate-fade-in-up pr-16 sm:pr-20" style={{ animationDelay: '0.3s' }}>
          <p className="text-xs text-muted-foreground text-center md:text-left">
            © {currentYear} Bharat Gunani. All rights reserved.
          </p>
